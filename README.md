...
-   `npm run eslint:style` - Проверка scss файлов style линтером
-   `npm run eslint:style:fix` - Исправление scss файлов style линтером
...
-   `npm run update:imports` - Скрипт для обновления импортов
-   `npm run create:publick:api` - Скрипт для создания public api
...
используется собственный eslint plugin _eslint-plugin-project-my-plugin_,
